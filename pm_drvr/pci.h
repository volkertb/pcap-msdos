...
#define PCI_DEVICE_ID_SI_6201                 0x0001  /* !! correct? */
...
#define PCI_DEVICE_ID_3COM_9056               0x9056
#define PCI_DEVICE_ID_3COM_9058               0x9058
#define PCI_DEVICE_ID_3COM_9004               0x9004
#define PCI_DEVICE_ID_3COM_9005               0x9005
#define PCI_DEVICE_ID_3COM_9006               0x9006
#define PCI_DEVICE_ID_3COM_900A               0x900A
#define PCI_DEVICE_ID_3COM_905A               0x905A
#define PCI_DEVICE_ID_3COM_9200               0x9200
#define PCI_DEVICE_ID_3COM_9800               0x9800
#define PCI_DEVICE_ID_3COM_9805               0x9805
#define PCI_DEVICE_ID_3COM_4500               0x4500
#define PCI_DEVICE_ID_3COM_7646               0x7646
...
#define PCI_DEVICE_ID_3DFX_VOODOO3            0x0005  /* !! correct? */
...
struct pci_dev {
       ...
       unsigned  devfn;            /* encoded device & function index */
       WORD      vendor;
       WORD      device;
       unsigned  class;            /* 3 bytes: (base,sub,prog-if) */
       unsigned  master : 1;       /* set if device is master capable */
       unsigned  rom_address : 1;
       unsigned  hdr_type;
        ...
        */
       BYTE     irq;               /* irq generated by this device */
       uint64   base_address [6];  /* base address of each bus */
     };
...
struct pci_bus {
       ...
       BYTE   number;              /* bus number */
       BYTE   primary;             /* number of primary bridge */
       BYTE   secondary;           /* number of secondary bridge */
       BYTE   subordinate;         /* max number of subordinate buses */
     };
...
struct pci_dev *pci_find_slot  (unsigned bus, unsigned dev);
struct pci_dev *pci_find_device(unsigned vnd, unsigned dev, struct pci_dev *from);
struct pci_dev *pci_find_class (unsigned cls, struct pci_dev *from);
