...
#ifndef __ETHER_EXPRESS_H
#define __ETHER_EXPRESS_H
...
#define TX_BUF_SIZE  ((24 +ETH_MAX+31) & ~0x1f)
#define RX_BUF_SIZE  ((32 +ETH_MAX+31) & ~0x1f)
...
struct rfd_header {
       ...
       volatile WORD  link;
       volatile WORD  rbd_offset;
       volatile WORD  dstaddr1;
       volatile WORD  dstaddr2;
       volatile WORD  dstaddr3;
       volatile WORD  srcaddr1;
       volatile WORD  srcaddr2;
       volatile WORD  srcaddr3;
        ...
        */
       volatile WORD  actual_count;
       volatile WORD  next_rbd;
       volatile WORD  buf_addr1;
       volatile WORD  buf_addr2;
       volatile WORD  size;
     };
