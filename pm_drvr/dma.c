...
static DMA_ENTRY mydma[] LOCKED_VAR =
{
   /* channel 0 */
 ...
 */
int _dma_allocate (int bytes, int *sel, DWORD *phys)
{
   int seg;
 ...
 */
void _dma_start (int channel, DWORD addr, int size, int auto_init, int input)
{
   DMA_ENTRY *tdma;
   DWORD page, offset;
   int   mode;
