...
struct Incoming
{
  ...
  BYTE lastpacket,  /* number of last packet (from 1) */
...
WORD arcnetA_type_trans(struct sk_buff *skb,struct device *dev);
...
WORD arcnetS_type_trans(struct sk_buff *skb,struct device *dev);
#endif
