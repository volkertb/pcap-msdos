...
/* Primary I/O Base Address. If no I/O base is supplied by the user,
 * then this. Can be used as the default I/O base to access the PacketPage
 * Area.
 */
 ...
 * Of course the IMM bit is not in that register so it must be masked out
 */
