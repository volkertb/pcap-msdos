 ...
 * =========================================================================
 */
#ifndef __ETHERWORKS_H
#define __ETHERWORKS_H

extern int ewrk3_debug;
...
#define EEPROM_OFFSET(a) ((WORD)((DWORD)(a)))
...
struct ewrk3_ioctl {
       WORD  cmd;          /* Command to run */
       WORD  len;          /* Length of the data buffer */
