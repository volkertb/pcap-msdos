...
static void modulator_9600_4(struct sm_state *sm, BYTE *buf, int buflen)
{
  int j;
  const BYTE *cp;
...
static void demodulator_9600_4(struct sm_state *sm, BYTE *buf, int buflen)
{
...
static void modulator_9600_5(struct sm_state *sm, BYTE *buf, int buflen)
{
  int j;
  const BYTE *cp;
...
static void demodulator_9600_5(struct sm_state *sm, BYTE *buf, int buflen)
{
  static const int pll_corr[2] = { -0x1000, 0x1000 };
  BYTE curbit;
  DWORD descx;
