...
struct tok_info {
  ...
  BYTE data_rate;
  BYTE token_release;
  BYTE avail_shared_ram;
  BYTE shared_ram_paging;
  BYTE dhb_size4mb;
  BYTE dhb_size16mb;
  ...
  BYTE page_mask;          /* mask to select RAM page to Map*/
  BYTE mapped_ram_size;    /* size of RAM page */
  ...
  WORD exsap_station_id;
  WORD global_int_enable;
  struct sk_buff *current_skb;
  struct tr_statistics tr_stats;
  BYTE auto_ringspeedsave;
  open_state open_status;
  BYTE readlog_pending;
  WORD adapter_int_enable; /* Adapter-specific int enable */
};
...
struct dir_open_adapter {
  ...
  __u16 open_options;
  BYTE node_address[6];
  BYTE group_address[4];
  BYTE funct_address[4];
  __u16 num_rcv_buf;
  __u16 rcv_buf_len;
  __u16 dhb_length;
  BYTE num_dhb;
...
struct srb_read_log {
  ...
  BYTE reserved2;
  BYTE line_errors;
  BYTE internal_errors;
  BYTE burst_errors;
  BYTE A_C_errors;
  BYTE abort_delimiters;
  BYTE reserved3;
  BYTE lost_frames;
  BYTE recv_congest_count;
  BYTE frame_copied_errors;
  BYTE frequency_errors;
  BYTE token_errors;
};
