...
struct arlan_private {
      ...
      volatile uint64 tx_done_delayed;
      volatile uint64 registrationLastSeen;
      volatile char under_command;
      volatile char under_toggle;
      volatile uint64 tx_last_sent;
      volatile uint64 tx_last_cleared;
      ...
      volatile uint64        last_tx_time;
      volatile uint64        last_rx_time;
      volatile uint64        last_rx_int_ack_time;
      int	in_bytes;
      int	out_bytes;
      int	in_time;
      int	out_time;
