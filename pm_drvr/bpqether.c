...
static BYTE ax25_defaddr[AX25_ADDR_LEN] =
...
static int bpq_device_event(struct notifier_block *, DWORD, void *);
static char *bpq_print_ethaddr(BYTE *);
 ...
 *  Proc filesystem
 */
static char * bpq_print_ethaddr(BYTE *e)
{
  static char buf[18];
...
static int bpq_new_device(struct device *dev)
{
  ...
  dev = &bpq->axdev;
  buf = (BYTE *)kmalloc(14, GFP_KERNEL);
 ...
 */
static int bpq_device_event(struct notifier_block *this,DWORD event, void *ptr)
{
